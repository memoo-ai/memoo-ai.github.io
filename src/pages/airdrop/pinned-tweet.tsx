...
const PinnedTweet: FC = () => {
  ...
  return (
    <div className="pinned-tweet px-[22px] pt-[33px] pb-[37px] mt-[11px]">
      ...
      <div className="font-404px text-[18px] mb-[23px] text-green">FEATURED TWEETS</div>
            ...
            return (
              <div key={index} className="my-masonry-grid-item">
                <div className="flex items-center">
                  ...
                  <div>
                    <h3 className="font-404px flex items-center gap-x-[10px] text-[16px] font-bold text-white">
                      {item.name} <IconTwitterAuth className="w-[16px] h-[16px]" />
                    </h3>
                    <p className="text-[14px] text-white font-OCR">@{item.username}</p>
                  </div>
                </div>
                <p className="font-OCR text-[11px] text-[#FFFFFF] leading-4 mt-[13px]">{item.text}</p>
                <div className="flex justify-between items-center mt-[26px]">
                  <span className="text-[#B53BFF] text-[12px] leading-[14px] font-OCR font-medium">
                    {item.twitterMsgCreatedAt}
                  </span>
                  <span className="text-[#B53BFF] text-[12px] leading-[14px] font-OCR font-medium flex items-center gap-[6px]">
