...
export const columns = [
  ...
  },
  {
    ...
    key: 'price',
    sorter: true,
    render: (price: number) => <div className="font-Montserrat font-semibold text-lg ">${price}</div>,
  },
  {
    title: '1h',
    ...
    render: (priceChangeHourly: number) => (
      <span className={`font-Montserrat font-semibold text-lg ${priceChangeHourly < 0 ? 'text-red' : 'text-green'}`}>
        {priceChangeHourly > 0 ? '+' : ''}
  ...
  },
  {
    ...
    render: (priceChangeDaily: number) => (
      <span className={`font-Montserrat font-semibold text-lg ${priceChangeDaily < 0 ? 'text-red' : 'text-green'}`}>
        {priceChangeDaily > 0 ? '+' : ''}
  ...
  },
  {
    ...
    key: 'volumeDaily',
    sorter: true,
    render: (volumeDaily: number) => <div className="font-Montserrat font-semibold text-lg ">${volumeDaily}</div>,
  },
  {
    title: 'Market Cap',
    dataIndex: 'marketCap',
    key: 'marketCap',
    render: (marketCap: number) => <div className="font-Montserrat font-semibold text-lg ">${marketCap}</div>,
  },
];
