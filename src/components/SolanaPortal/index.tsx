...
export const SolanaPortalWalletTop: FC<{ children: ReactNode; update: number }> = ({ children, update = 1 }) => {
  const [modalRoot, setModalRoot] = useState<HTMLDivElement | null>(null);
...
export const SolanaPortalWalletBottom: FC<{ children: ReactNode; update: number }> = ({ children, update = 0 }) => {
  const [modalRoot, setModalRoot] = useState<HTMLDivElement | null>(null);
