...
export async function getNFTMetadata(mint: string, conn: Connection, pubkey?: string): Promise<INFT | undefined> {
...
export async function getNFTMetadataForMany(tokens: any[], conn: Connection): Promise<INFT[]> {
...
export async function getNFTsByOwner(owner: PublicKey, conn: Connection): Promise<INFT[]> {
