...
export interface LiquidityHolderInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MEMOO_MANAGE_ROLE"
...
export interface LiquidityHolder extends BaseContract {
  connect(runner?: ContractRunner | null): LiquidityHolder;
  waitForDeployment(): Promise<this>;

  interface: LiquidityHolderInterface;
  ...
  lockLiquidity: TypedContractMethod<
    [params: MemooManageStructs.LockLPTokenParamsStruct],
    [void],
    "nonpayable"
  >;
