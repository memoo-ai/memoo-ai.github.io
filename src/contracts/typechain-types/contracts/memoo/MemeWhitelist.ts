...
export interface MemeWhitelistInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "PAUSER_ROLE"
...
export interface MemeWhitelist extends BaseContract {
  connect(runner?: ContractRunner | null): MemeWhitelist;
  waitForDeployment(): Promise<this>;

  interface: MemeWhitelistInterface;
  ...
  setWhitelist: TypedContractMethod<
    [meme: AddressLike, roots: BytesLike[], reset: boolean],
    [void],
    "nonpayable"
  >;
